...
class BalancedColumns(_FindSplitterMixin,NullDraw):
    ...
    def _generated_content(self,aW,aH):
        ...
        #we are going to modify the current templates
        ...
        class TAction(ActionFlowable):
            '''a special Action flowable that sets stuff on the doc templates T'''
...
class FrameSplitter(NullDraw):
    ...
    temporarily modify the current templates to have the frames from nextTemplate
